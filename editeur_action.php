...
<form method="post" action="save.php">
	<input type="submit" name="button11" class="save" value="Save" style="position:absolute;left:42%;margin-top:20px;border-radius:20px;border:1px solid white;background:transparent;font-size:200%;width:300px;color: white;">
</form>

<a href="editeur.php" id="target" style="position:absolute;margin-top:100px;border-radius:20px;left:42%;border:1px solid white;background:transparent;font-size:200%;width:300px;color: white;">RESET</a>
